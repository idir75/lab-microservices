package ida.microservices.book.gamification.repository;

import ida.microservices.book.gamification.domain.LeaderBoardRow;
import ida.microservices.book.gamification.domain.ScoreCard;
...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
     ...
     */
    @Query("SELECT SUM(s.score) FROM ida.microservices.book.gamification.domain.ScoreCard s WHERE s.userId = :userId GROUP BY s.userId")
     ...
     */
    @Query("SELECT NEW ida.microservices.book.gamification.domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
    "FROM ida.microservices.book.gamification.domain.ScoreCard s " +
