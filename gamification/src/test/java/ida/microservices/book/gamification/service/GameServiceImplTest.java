...
import ida.microservices.book.gamification.event.MultiplicationSolvedEvent;
import ida.microservices.book.gamification.repository.BadgeCardRepository;
...
public class GameServiceImplTest {
    ...
    public void setUp() {
        ...
        MultiplicationResultAttempt attempt = new MultiplicationResultAttempt("ida", 20, 70, 1400, true);
    ...
    public void processCorrectAttemptForLuckyNumberBadgeTest() {
        ...
        MultiplicationResultAttempt attempt = new MultiplicationResultAttempt("ida", 42, 10, 420, true);
